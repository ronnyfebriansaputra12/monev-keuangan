...
<div class="page-header mb-4">
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h4 class="page-title mb-0">Tambah Komponen</h4>
...
{{-- Summary error (optional, boleh dipakai) --}}
@if ($errors->any())
...
<div class="card">
    <div class="card-header">
        <div class="card-title mb-0">Form Tambah Komponen</div>
    </div>

    <form action="{{ route('master.komponens.store') }}" method="POST" autocomplete="off">
        @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="rincian_output_id"
                        ...
                        <option value="{{ $ro->id }}"
                            @selected(old('rincian_output_id')==$ro->id)>
        ...
        <div class="card-footer d-flex justify-content-end gap-2">
            <a href="{{ route('master.komponens.index') }}" class="btn btn-light">Batal</a>
