...
<div class="page-header mb-4">
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h4 class="page-title mb-1">Master Akun</h4>
            <ul class="breadcrumbs bg-transparent p-0 m-0 d-flex align-items-center" style="list-style: none; gap: 8px;">
                ...
                <li class="separator text-muted"><i class="fas fa-chevron-right" style="font-size: 0.7rem;"></i></li>
                <li class="nav-item"><span class="font-weight-bold text-dark">Master Akun</span></li>
            </ul>
        </div>
        <a href="{{ route('master.master-akuns.create') }}" class="btn btn-primary rounded-pill px-4 shadow-sm">
...
<div class="filter-section border-0 shadow-sm">
    <form method="GET" action="{{ route('master.master-akuns.index') }}">
        <div class="row align-items-end g-3">
            ...
            <div class="col-md-4">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('master.master-akuns.index') }}" class="btn btn-sm btn-light border flex-fill text-center">
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <div class="table-responsive">
            <table id="dtMasterAkuns" class="table table-hover w-100">
                <thead>
                    <tr>
                        <th class="text-center" style="width:60px">No</th>
                        <th class="text-center" style="width:180px">Kode Akun</th>
                        <th>Nama Akun</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <code>{{ $a->kode_akun }}</code>
                        </td>
                        <td class="align-middle font-weight-bold text-dark">{{ $a->nama_akun }}</td>
                        <td class="text-center align-middle">
                            <div class="btn-group">
                                {{-- Ikon Edit: Style Samakan dengan Realisasi --}}
                                <a href="{{ route('master.master-akuns.edit', $a) }}" 
