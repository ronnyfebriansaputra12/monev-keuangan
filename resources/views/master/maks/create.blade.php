...
<div class="page-header mb-4">
    <div class="d-flex align-items-start justify-content-between flex-wrap gap-2">
        <div>
            <h4 class="page-title mb-1">Tambah MAK</h4>
...
<div class="card">
    <div class="card-header">
        <div class="card-title mb-0">Form Tambah MAK</div>
    </div>

    <form action="{{ route('master.maks.store') }}" method="POST" autocomplete="off">
        @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="akun_id" class="form-select @error('akun_id') is-invalid @enderror">
                        ...
                        @foreach($akuns as $a)
                        <option value="{{ $a->id }}" @selected(old('akun_id') == $a->id)>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="Contoh: Belanja Modal / Barang / Pegawai"
                           maxlength="50">
                    @error('jenis_belanja')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
