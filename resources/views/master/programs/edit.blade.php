...
<div class="page-header mb-4">
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h4 class="page-title mb-0">Edit Program</h4>
...
<div class="card">
    <div class="card-header">
        <div class="card-title mb-0">Form Edit Program</div>
    </div>

    <form action="{{ route('master.programs.update', $program) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="satker_id" class="form-select @error('satker_id') is-invalid @enderror">
                        ...
                        @foreach($satkers as $s)
                            <option value="{{ $s->id }}" @selected(old('satker_id', $program->satker_id) == $s->id)>
                                {{ $s->nama_satker }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="tahun_anggaran"
                           value="{{ old('tahun_anggaran', $program->tahun_anggaran) }}"
