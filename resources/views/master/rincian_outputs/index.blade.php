...
<div class="page-header mb-4">
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h4 class="page-title mb-1">Master Rincian Output (RO)</h4>
            <ul class="breadcrumbs bg-transparent p-0 m-0 d-flex align-items-center" style="list-style: none; gap: 8px;">
                ...
                <li class="separator text-muted"><i class="fas fa-chevron-right" style="font-size: 0.7rem;"></i></li>
                <li class="nav-item"><span class="font-weight-bold text-dark">Rincian Output</span></li>
            </ul>
        </div>
        <a href="{{ route('master.rincian-outputs.create') }}" class="btn btn-primary rounded-pill px-4 shadow-sm">
            <i class="fas fa-plus-circle mr-2"></i> Tambah Rincian Output
        </a>
    </div>
</div>
@endsection
...
<div class="filter-section border-0 shadow-sm">
    <form method="GET" action="{{ route('master.rincian-outputs.index') }}">
        <div class="row align-items-end g-3">
            <div class="col-md-4">
                <label class="small font-weight-bold text-uppercase text-muted mb-2 d-block">Klasifikasi RO</label>
                <select name="klasifikasi_ro_id" class="form-select form-select-sm shadow-none border-gray-300">
            ...
            <div class="col-md-2">
                ...
                <input type="number" name="tahun" class="form-control form-control-sm shadow-none border-gray-300" 
                       placeholder="Tahun" value="{{ $tahun }}" min="2000" max="2100">
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="input-group input-group-sm">
                    ...
                    <input type="text" name="search" class="form-control border-left-0 shadow-none" 
                           placeholder="Cari kode atau nama RO..." value="{{ $search }}">
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('master.rincian-outputs.index') }}" class="btn btn-sm btn-light border flex-fill text-center">
...
<div class="card shadow-sm border-0">
    <div class="card-body p-4">
        <div class="table-responsive">
            <table id="dtRO" class="table table-hover w-100">
                <thead>
                    <tr>
                        <th class="text-center" style="width:50px">No</th>
                        <th>Struktur Atas</th>
                        <th class="text-center" style="width:120px">Kode RO</th>
                        <th>Nama Rincian Output</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="text-structure text-uppercase">{{ $ro->klasifikasiRo?->kegiatan?->program?->satker?->nama_satker }}</div>
                            <div class="small text-muted">
                                <span class="badge badge-light border text-dark" style="font-size: 0.65rem;">KRO: {{ $ro->klasifikasiRo?->kode_klasifikasi }}</span>
                            </div>
                        </td>
                        <td class="text-center align-middle font-weight-bold text-dark">
                            <code>{{ $ro->kode_ro }}</code>
                        </td>
                        <td class="align-middle font-weight-bold text-dark">{{ $ro->nama_ro }}</td>
...
$(function () {
    ...
    $(document).on('submit', '.form-delete', function (e) {
        ...
        swal({
            title: "Yakin hapus?",
            text: "Data Rincian Output ini tidak bisa dikembalikan.",
            icon: "warning",
            buttons: {
