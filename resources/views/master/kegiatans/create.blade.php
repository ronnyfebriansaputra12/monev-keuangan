...
<div class="page-header mb-4">
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h4 class="page-title mb-0">Tambah Kegiatan</h4>
...
<div class="card">
    <div class="card-header">
        <div class="card-title mb-0">Form Tambah Kegiatan</div>
    </div>

    <form action="{{ route('master.kegiatans.store') }}" method="POST" autocomplete="off">
        @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="nama_kegiatan"
                        ...
                        placeholder="Contoh: Pengembangan Aplikasi" maxlength="255">
