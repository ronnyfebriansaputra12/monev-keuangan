...
<div class="page-header mb-4">
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h4 class="page-title mb-0">Edit Klasifikasi RO</h4>
...
<div class="card">
    <div class="card-header">
        <div class="card-title mb-0">Form Edit Klasifikasi RO</div>
    </div>

    <form action="{{ route('master.klasifikasi-ros.update', $klasifikasiRo) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="kegiatan_id" class="form-select @error('kegiatan_id') is-invalid @enderror">
                        ...
                        @foreach($kegiatans as $k)
                            <option value="{{ $k->id }}" @selected(old('kegiatan_id', $klasifikasiRo->kegiatan_id) == $k->id)>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="tahun_anggaran"
                           value="{{ old('tahun_anggaran', $klasifikasiRo->tahun_anggaran) }}"
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="kode_klasifikasi"
                           value="{{ old('kode_klasifikasi', $klasifikasiRo->kode_klasifikasi) }}"
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="nama_klasifikasi"
                           value="{{ old('nama_klasifikasi', $klasifikasiRo->nama_klasifikasi) }}"
