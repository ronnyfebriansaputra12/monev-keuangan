...
<div class="page-header mb-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-2">
        <h4 class="page-title mb-0">Edit Satker</h4>
...
<div class="card">
    <div class="card-header">
        <div class="card-title mb-0">Form Edit Satker</div>
    </div>

    <form action="{{ route('master.satkers.update', $satker) }}" method="POST" autocomplete="off">
        @csrf
        @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input
                        type="number"
                        name="tahun_anggaran"
                        value="{{ old('tahun_anggaran', $satker->tahun_anggaran) }}"
